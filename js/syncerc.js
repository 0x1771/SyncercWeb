    ...
    var header = $("header");
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme')){
            window.location.href = 'https://www. .com/themes/gospace/index.html';
        }else{
            window.location.href = 'https://www. .com/themes/gospace/02_dark-index.html';
        }
     });
